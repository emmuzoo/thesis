...
def sentiment_analysis_flow(raw_dataset_path: str, data_path:str, 
    ...
    #run_data_prep(raw_dataset_path, data_path, max_features, test_size, val_size)
...
if __name__ == '__main__':
    #run_workflow()
    sentiment_analysis_flow.serve(name="sentiment-analysis-deployment",
        parameters={
            "raw_dataset_path": "/workspaces/mlops-zoomcamp/project/raw/IMDB Dataset.csv",
